class TodoListsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @todo_list.save
        format.html { redirect_to new_todo_list_path, notice: "Todo list '#{@todo_list.title}' was successfully created." }
  ...
  private
    ...
    def todo_list_params
      params.require(:todo_list).permit(:title, :timestamps)
    end
end
